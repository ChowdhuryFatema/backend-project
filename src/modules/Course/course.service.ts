...
import { TCourseFaculty, TCrouse } from './course.interface';
import { Course, CourseFaculty } from './course.model';
import { AppError } from '../../errors/AppError';
import { StatusCodes } from 'http-status-codes';

const createCourseIntoDB = async (payload: TCrouse) => {
...
const updateCourseIntoDB = async (id: string, payload: Partial<TCrouse>) => {
